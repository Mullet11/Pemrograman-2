...
public class BukuService {
    ...
    // Regex untuk judul & nama penulis (hanya huruf, spasi, dan apostrophe)
    ...
    private void validate(Buku b) throws Exception {
        ...
        if (!NAME_PATTERN.matcher(b.getJudul().trim()).matches()) {
            throw new Exception("Judul hanya boleh berisi huruf, spasi, dan tanda apostrophe ('). Tidak boleh mengandung angka atau simbol lainnya!");
        }
        ...
        if (!NAME_PATTERN.matcher(b.getPenulis().trim()).matches()) {
            throw new Exception("Nama penulis hanya boleh berisi huruf, spasi, dan tanda apostrophe ('). Tidak boleh mengandung angka atau simbol!");
        }
